...
% needspace: permite exigir uma altura minima de espaco na pagina atual
% antes de comecar um bloco (ex.: tabela grande). Se nao houver, quebra
% para a proxima pagina. Uso: \needspace{18\baselineskip} antes do bloco.
